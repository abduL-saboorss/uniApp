...
namespace FormsApp1
{
    partial class LoginForm : System.Windows.Forms.Form // Inherit from Form to use Dispose method
    {
        ...
        private System.Windows.Forms.Button btnSignup; // Renamed from 'signup' to 'btnSignup'
        ...
        // Ensure the btnLogin_Click event handler is properly wired
        ...
        // Add the 'new' keyword to hide the inherited member
